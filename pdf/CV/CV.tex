...
Research Scientist attracted to hard problems. Visiting Researcher at Georgetown University. Built data science research groups at Twitter, Acronym, Pew Research Center. High-impact publications. Industry experience: recommender systems/ML, complex experimentation/causal inference, ads experimentation, modeling, HCI, algorithm audits, differential privacy. Technical experience working with distributed computing platforms (Hive/Hadoop/GCP/K8/etc.), Keras/TensorFlow/Pytorch, Django, Tidyverse, etc. 
\vspace{0.1in}
...
\item[] \href{https://solomonmg.github.io/pdf/acronym_nature_human_behavior_preprint_web.pdf}{\emph{A 2 Million Person, Campaign-wide Field Experiment Shows How Digital Advertising Affects Voter Turnout}}. Aggarwal, Allen, Coppock, Frankowski, Messing, Zhang, Barnes, Beasley, Hantman, \& Zheng.
%(joint-first-author). 
\emph{Nature Human Behavior, forthcoming}. \\ 


\item[] \href{https://www.journals.uchicago.edu/doi/abs/10.1086/708682}{\emph{Projecting Confidence: How the Probabilistic Horse Race Confuses \& Demobilizes the Public}}. Westwood, Messing \& Lelkes. 
%(joint-first-author). 
